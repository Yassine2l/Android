...
public class MainEx6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog alertDialog = new AlertDialog.Builder(MainEx6Activity.this).create();
                ...
                alertDialog.setButton(AlertDialog.BUTTON_POSITIVE,getResources().getText(R.string.confirmation), new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent i = new Intent(getApplicationContext(),ex6Activity2.class);
                        Bundle b = new Bundle();
                        b.putString("firstName",textFirstName.getText().toString());
                        b.putString("lastName",textLastName.getText().toString());
                        b.putString("Age",textAge.getText().toString());
                        b.putString("Competance",textCompetance.getText().toString());
                        b.putString("Phone",textPhone.getText().toString());
                        i.putExtras(b);
                        startActivity(i);
                    }
                });
